...
#
# pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:20
class Hash
  include ::Enumerable

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:21
  def destroy; end
end
...
#
# pkg:gem/sorcery#lib/sorcery/version.rb:1
module Sorcery
  class << self
    # pkg:gem/sorcery#lib/sorcery.rb:5
    def deprecator; end
  end
end

# pkg:gem/sorcery#lib/sorcery.rb:11
module Sorcery::Adapters; end

# pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:3
class Sorcery::Adapters::ActiveRecordAdapter < ::Sorcery::Adapters::BaseAdapter
  # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:22
  def find_authentication_by_oauth_credentials(relation_name, provider, uid); end

  # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:18
  def increment(field); end

  # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:13
  def save(options = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:4
  def update_attributes(attrs); end

  class << self
    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:37
    def define_callback(time, event, method_name, options = T.unsafe(nil)); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:33
    def define_field(name, type, options = T.unsafe(nil)); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:81
    def find_by_activation_token(token); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:55
    def find_by_credentials(credentials); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:98
    def find_by_email(email); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:85
    def find_by_id(id); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:41
    def find_by_oauth_credentials(provider, uid); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:51
    def find_by_remember_me_token(token); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:75
    def find_by_token(token_attr_name, token); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:89
    def find_by_username(username); end

    # pkg:gem/sorcery#lib/sorcery/adapters/active_record_adapter.rb:102
    def transaction(&_arg0); end
  end
end

# pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:3
class Sorcery::Adapters::BaseAdapter
  # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:4
  def initialize(model); end

  # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:21
  def increment(field); end

  # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:25
  def update_attribute(name, value); end

  class << self
    # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:13
    def delete_all; end

    # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:17
    def find(id); end

    # pkg:gem/sorcery#lib/sorcery/adapters/base_adapter.rb:8
    def from(klass); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller.rb:2
module Sorcery::Controller
  include ::Sorcery::Controller::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/controller.rb:3
    def included(klass); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/config.rb:3
module Sorcery::Controller::Config
  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:5
    ...
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:5
    def after_login_lock; end

    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:5
    def after_login_lock=(_arg0); end
    ...
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:54
    def configure(&blk); end

    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:58
    def configure!; end
    ...
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:19
    def init!; end
    ...
    #
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:38
    def reset!; end
    ...
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:44
    def update!; end

    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:5
    def use_redirect_back_or_to_by_rails; end

    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:5
    def use_redirect_back_or_to_by_rails=(_arg0); end
    ...
    # pkg:gem/sorcery#lib/sorcery/controller/config.rb:50
    def user_config(&blk); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller.rb:16
module Sorcery::Controller::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:132
  def auto_login(user, _should_remember = T.unsafe(nil)); end

  # attempts to auto-login from the sources defined (session, basic_auth, cookie, etc.)
  # returns the logged in user if found, nil if not
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:89
  def current_user; end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:94
  def current_user=(user); end

  # Overwrite Rails' handle unverified request
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:138
  def handle_unverified_request; end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:83
  def logged_in?; end

  # Takes credentials and returns a user on successful authentication.
  # Runs hooks after login or failed login.
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:32
  def login(*credentials); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:60
  def login!(*_arg0, **_arg1, &_arg2); end

  # Resets the session and runs hooks before and after.
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:73
  def logout; end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:124
  def not_authenticated; end

  # used when a user tries to access a page while logged out, is asked to login,
  # and we want to return him back to the page he originally wanted.
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:100
  def redirect_back_or_to(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:113
  def redirect_to_before_login_path(url, **options); end

  # To be used as before_action.
  # Will trigger auto-login attempts via the call to logged_in?
  # If all attempts to auto-login fail, the failure callback will be called.
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:20
  def require_login; end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:68
  def reset_sorcery_session; end

  protected

  # pkg:gem/sorcery#lib/sorcery/controller.rb:163
  def after_failed_login!(credentials); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:159
  def after_login!(user, credentials = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:179
  def after_login_lock!(credentials); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:171
  def after_logout!(user); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:175
  def after_remember_me!(user); end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:167
  def before_logout!; end

  # Tries all available sources (methods) until one doesn't return false.
  #
  # pkg:gem/sorcery#lib/sorcery/controller.rb:147
  def login_from_other_sources; end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:155
  def login_from_session; end

  # pkg:gem/sorcery#lib/sorcery/controller.rb:183
  def user_class; end
end

# pkg:gem/sorcery#lib/sorcery.rb:34
...
# options.
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:14
module Sorcery::Controller::Submodules::ActivityLogging
  ...
  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:15
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:38
module Sorcery::Controller::Submodules::ActivityLogging::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:59
  def register_last_activity_time_to_db; end

  # Updates IP address on every login.
  # This runs as a hook just after a successful login.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:68
  def register_last_ip_address(_user, _credentials); end

  # registers last login time on every login.
  # This runs as a hook just after a successful login.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:43
  def register_login_time_to_db(user, _credentials); end

  # registers last logout time on every logout.
  # This runs as a hook just before a logout.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/activity_logging.rb:51
...
# options.
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/brute_force_protection.rb:10
module Sorcery::Controller::Submodules::BruteForceProtection
  ...
  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/brute_force_protection.rb:11
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/brute_force_protection.rb:18
module Sorcery::Controller::Submodules::BruteForceProtection::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/brute_force_protection.rb:33
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/brute_force_protection.rb:23
...
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:6
module Sorcery::Controller::Submodules::External
  include ::Sorcery::Controller::Submodules::External::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:7
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:58
module Sorcery::Controller::Submodules::External::InstanceMethods
  protected

  # for backwards compatibility
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:100
  def access_token(*_args); end

  # If user is logged, he can add all available providers into his account
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:145
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:198
  def build_from(provider_name, &_arg1); end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:155
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:189
  def create_from(provider_name, &_arg1); end

  # sends user to authenticate at the provider's website.
  # after authentication the user is redirected to the callback defined in the provider config
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:120
  def login_at(provider_name, args = T.unsafe(nil)); end

  # tries to login the user from provider's callback
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:125
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:81
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:105
  def sorcery_fixup_callback_url(provider); end

  # save the singleton ProviderClient instance into @provider
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:62
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:70
  def sorcery_login_url(provider_name, args = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/controller/submodules/external.rb:206
...
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:9
module Sorcery::Controller::Submodules::HttpBasicAuth
  include ::Sorcery::Controller::Submodules::HttpBasicAuth::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:10
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:26
module Sorcery::Controller::Submodules::HttpBasicAuth::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:49
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:60
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/http_basic_auth.rb:39
...
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:8
module Sorcery::Controller::Submodules::RememberMe
  include ::Sorcery::Controller::Submodules::RememberMe::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:9
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:26
module Sorcery::Controller::Submodules::RememberMe::InstanceMethods
  # Override.
  # logins a user instance, and optionally remembers him.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:47
  def auto_login(user, should_remember = T.unsafe(nil)); end

  # Clears the cookie, and clears the token value.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:40
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:34
  def forget_me!; end

  # This method sets the cookie and calls the user to save the token and the expiration to db.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:28
  def remember_me!; end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:58
  def login_from_cookie; end

  # pkg:gem/sorcery#lib/sorcery/controller/submodules/remember_me.rb:70
...
#
# pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:6
module Sorcery::Controller::Submodules::SessionTimeout
  include ::Sorcery::Controller::Submodules::SessionTimeout::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:7
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:33
module Sorcery::Controller::Submodules::SessionTimeout::InstanceMethods
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:34
  ...
  # Runs as a hook after a successful login.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:46
  def register_login_time(_user, _credentials = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:62
  def sorcery_session_expired?(time); end

  # Use login time if present, otherwise use last action time.
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:67
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/controller/submodules/session_timeout.rb:52
...
#   end
#
# pkg:gem/sorcery#lib/sorcery.rb:49
...
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:20
class Sorcery::CryptoProviders::AES256
  class << self
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:36
    def decrypt(crypted); end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:24
    def encrypt(*tokens); end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:22
    def key=(_arg0); end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:30
    def matches?(crypted, *tokens); end

    private

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/aes256.rb:44
    def aes; end
  end
end
...
# You are good to go!
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:41
class Sorcery::CryptoProviders::BCrypt
  class << self
    ...
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:52
    def cost; end
    ...
    # security and performance.
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:55
    def cost=(_arg0); end

    # This method is used as a flag to tell Sorcery to "resave" the password
    # upon a successful login, using the new cost
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:74
    def cost_matches?(hash); end

    # Creates a BCrypt hash for the password passed.
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:60
    def encrypt(*tokens); end

    # Does the hash match the tokens? Uses the same tokens that were used to encrypt.
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:65
    ...
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:46
    def pepper; end
    ...
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:83
    def reset!; end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:56
    def stretches; end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:57
    def stretches=(_arg0); end

    private

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:90
    def join_tokens(tokens); end

    # pkg:gem/sorcery#lib/sorcery/crypto_providers/bcrypt.rb:94
    def new_from_hash(hash); end
  end
end

# pkg:gem/sorcery#lib/sorcery/crypto_providers/common.rb:3
module Sorcery::CryptoProviders::Common
  class << self
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/common.rb:4
    def included(base); end
  end
end
...
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/md5.rb:10
class Sorcery::CryptoProviders::MD5
  include ::Sorcery::CryptoProviders::Common

  class << self
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/md5.rb:11
    def encrypt(*tokens); end
    ...
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/md5.rb:14
...
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/sha1.rb:7
class Sorcery::CryptoProviders::SHA1
  ...
  class << self
    ...
    #
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha1.rb:8
    def encrypt(*tokens); end
    ...
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha1.rb:23
    def secure_digest(digest); end
...
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/sha256.rb:27
class Sorcery::CryptoProviders::SHA256
  include ::Sorcery::CryptoProviders::Common

  class << self
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha256.rb:28
    def encrypt(*tokens); end
    ...
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha256.rb:31
    def secure_digest(digest); end
...
#
# pkg:gem/sorcery#lib/sorcery/crypto_providers/sha512.rb:27
class Sorcery::CryptoProviders::SHA512
  include ::Sorcery::CryptoProviders::Common

  class << self
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha512.rb:28
    def encrypt(*tokens); end
    ...
    # pkg:gem/sorcery#lib/sorcery/crypto_providers/sha512.rb:31
    def secure_digest(digest); end
...
#
# pkg:gem/sorcery#lib/sorcery/engine.rb:7
class Sorcery::Engine < ::Rails::Engine; end

# Custom error class for rescuing from all Sorcery errors.
#
# pkg:gem/sorcery#lib/sorcery/errors.rb:7
class Sorcery::Error < ::StandardError; end

# pkg:gem/sorcery#lib/sorcery/errors.rb:9
class Sorcery::InvalidCredentials < ::Sorcery::Error; end
...
#
# pkg:gem/sorcery#lib/sorcery/model.rb:9
module Sorcery::Model
  # pkg:gem/sorcery#lib/sorcery/model.rb:10
  def authenticates_with_sorcery!; end

  private

  # pkg:gem/sorcery#lib/sorcery/model.rb:31
  def define_base_fields; end

  # includes required submodules into the model class,
  # which usually is called User.
  #
  # pkg:gem/sorcery#lib/sorcery/model.rb:46
  def include_required_submodules!; end

  # add virtual password accessor and ORM callbacks.
  #
  # pkg:gem/sorcery#lib/sorcery/model.rb:60
  def init_orm_hooks!; end
end

# pkg:gem/sorcery#lib/sorcery/model.rb:72
...
class Sorcery::Model::Config
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:32
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:14
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:48
  def custom_encryption_provider; end

  # pkg:gem/sorcery#lib/sorcery/model/config.rb:88
  def custom_encryption_provider=(provider); end

  # downcase the username before trying to authenticate, default is false
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:12
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:10
  ...
  # method to send email related
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:37
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:50
  def encryption_algorithm; end

  # pkg:gem/sorcery#lib/sorcery/model/config.rb:92
  def encryption_algorithm=(algo); end

  # encryption key used to encrypt reversible encryptions such as AES256.
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:26
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:46
  def encryption_provider; end

  # change *virtual* password attribute, the one which is used until an encrypted one is generated.
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:8
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:17
  def pepper; end
  ...
  # Resets all configuration options to their default values.
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:78
  def reset!; end

  # change default salt attribute.
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:22
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:20
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:24
  def stretches; end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:28
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:30
  def submodules; end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:41
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/config.rb:44
  def username_attribute_names; end

  # pkg:gem/sorcery#lib/sorcery/model/config.rb:84
  def username_attribute_names=(fields); end
end

# pkg:gem/sorcery#lib/sorcery/model.rb:159
module Sorcery::Model::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model.rb:207
  def generic_send_email(method, mailer); end
end

# pkg:gem/sorcery#lib/sorcery.rb:19
...
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:9
module Sorcery::Model::Submodules::ActivityLogging
  include ::Sorcery::Model::Submodules::ActivityLogging::InstanceMethods

  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:10
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:78
module Sorcery::Model::Submodules::ActivityLogging::ClassMethods
  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:81
  def define_activity_logging_fields; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:39
module Sorcery::Model::Submodules::ActivityLogging::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:64
  def logged_in?; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:73
  def logged_out?; end

  # online method shows if user is active (logout action makes user inactive too)
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:57
  def online?; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:48
  def set_last_activity_at(time); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:52
  def set_last_ip_address(ip_address); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:40
  def set_last_login_at(time); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/activity_logging.rb:44
...
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:8
module Sorcery::Model::Submodules::BruteForceProtection
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:9
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:42
module Sorcery::Model::Submodules::BruteForceProtection::ClassMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:44
  def load_from_unlock_token(token, &_arg1); end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:56
  def define_brute_force_protection_fields; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:63
module Sorcery::Model::Submodules::BruteForceProtection::InstanceMethods
  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:90
  ...
  # /!\
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:82
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:66
  def register_failed_login!; end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:96
  def login_lock!; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:107
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:120
  def prevent_locked_user_login; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/brute_force_protection.rb:112
...
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:16
module Sorcery::Model::Submodules::External
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:17
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:38
module Sorcery::Model::Submodules::External::ClassMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:80
  def build_from_provider(attrs); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:49
  def create_and_validate_from_provider(provider, uid, attrs); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:59
  def create_from_provider(provider, uid, attrs); end

  # takes a provider and uid and finds a user by them.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:40
  def load_from_provider(provider, uid); end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:92
module Sorcery::Model::Submodules::External::InstanceMethods
  # pkg:gem/sorcery#lib/sorcery/model/submodules/external.rb:93
...
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:12
module Sorcery::Model::Submodules::MagicLogin
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:13
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:52
module Sorcery::Model::Submodules::MagicLogin::ClassMethods
  # Find user by token, also checks for expiration.
  # Returns the user if token found and is valid.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:55
  def load_from_magic_login_token(token, &_arg1); end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:75
  def define_magic_login_fields; end

  # This submodule requires the developer to define his own mailer class to be used by it
  # when magic_login_mailer_disabled is false
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:68
  def validate_mailer_defined; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:82
module Sorcery::Model::Submodules::MagicLogin::InstanceMethods
  # Clears the token.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:117
  def clear_magic_login_token!; end

  # generates a magic login code with expiration and sends an email to the user.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:98
  def deliver_magic_login_instructions!; end

  # generates a reset code with expiration
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:84
  def generate_magic_login_token!; end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/magic_login.rb:127
...
# until the cookie expires.
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:7
module Sorcery::Model::Submodules::RememberMe
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:8
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:31
module Sorcery::Model::Submodules::RememberMe::ClassMethods
  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:34
  def define_remember_me_fields; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:40
module Sorcery::Model::Submodules::RememberMe::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:65
  def force_forget_me!; end
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:60
  def forget_me!; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:54
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/remember_me.rb:42
  def remember_me!; end
end
...
# When using this submodule, supplying a mailer is mandatory.
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:12
module Sorcery::Model::Submodules::ResetPassword
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:13
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:59
module Sorcery::Model::Submodules::ResetPassword::ClassMethods
  # Find user by token, also checks for expiration.
  # Returns the user if token found and is valid.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:62
  def load_from_reset_password_token(token, &_arg1); end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:82
  def define_reset_password_fields; end

  # This submodule requires the developer to define his own mailer class to be used by it
  # when reset_password_mailer_disabled is false
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:75
  def validate_mailer_defined; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:89
module Sorcery::Model::Submodules::ResetPassword::InstanceMethods
  # Clears token and tries to update the new password for the user.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:133
  def change_password(new_password, raise_on_failure: T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:139
  def change_password!(new_password); end

  # Generates a reset code with expiration and sends an email to the user.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:103
  def deliver_reset_password_instructions!; end

  # Generates a reset code with expiration
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:91
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:121
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:127
  ...
  # Clears the token.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:152
  def clear_reset_password_token; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/reset_password.rb:147
...
# When using this submodule, supplying a mailer is mandatory.
#
# pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:8
module Sorcery::Model::Submodules::UserActivation
  class << self
    # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:9
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:59
module Sorcery::Model::Submodules::UserActivation::ClassMethods
  # Find user by token, also checks for expiration.
  # Returns the user if token found and is valid.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:62
  def load_from_activation_token(token, &_arg1); end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:82
  def define_user_activation_fields; end

  # This submodule requires the developer to define his own mailer class to be used by it
  # when activation_mailer_disabled is false
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:75
  def validate_mailer_defined; end
end

# pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:91
module Sorcery::Model::Submodules::UserActivation::InstanceMethods
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:103
  def activate!; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:92
  def setup_activation; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:111
  ...
  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:136
  def prevent_non_active_login; end

  # called automatically after user initial creation.
  #
  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:116
  def send_activation_needed_email!; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:130
  def send_activation_needed_email?; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:120
  def send_activation_success_email!; end

  # pkg:gem/sorcery#lib/sorcery/model/submodules/user_activation.rb:124
  def send_activation_success_email?; end
end
...
#
# pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:8
module Sorcery::Model::TemporaryToken
  ...
  class << self
    ...
    #
    # pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:16
    def generate_random_token; end

    # pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:9
    def included(base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:20
module Sorcery::Model::TemporaryToken::ClassMethods
  # pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:21
  def load_from_token(token, token_attr_name, token_expiration_date_attr = T.unsafe(nil), &_arg3); end

  protected

  # pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:37
  def check_expiration_date(user, token_expiration_date_attr); end

  # pkg:gem/sorcery#lib/sorcery/model/temporary_token.rb:45
  def token_response(options = T.unsafe(nil)); end
end

# pkg:gem/sorcery#lib/sorcery.rb:44
module Sorcery::Protocols; end

# pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:5
module Sorcery::Protocols::Oauth
  # pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:16
  def authorize_url(args); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:23
  def get_access_token(args); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:10
  def get_request_token(token = T.unsafe(nil), secret = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:6
  def oauth_version; end

  protected

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth.rb:32
  def get_consumer; end
end

# pkg:gem/sorcery#lib/sorcery/protocols/oauth2.rb:5
module Sorcery::Protocols::Oauth2
  # pkg:gem/sorcery#lib/sorcery/protocols/oauth2.rb:10
  def authorize_url(options = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth2.rb:32
  def build_client(options = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth2.rb:20
  def get_access_token(args, options = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/protocols/oauth2.rb:6
  def oauth_version; end
end

# pkg:gem/sorcery#lib/sorcery.rb:59
...
#
# pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:5
module Sorcery::TestHelpers::Internal
  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:26
  def build_new_user(attributes_hash = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:37
  def create_new_external_user(provider, attributes_hash = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:31
  def create_new_user(attributes_hash = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:45
  def custom_create_new_external_user(provider, authentication_class, attributes_hash = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:55
  def sorcery_model_property_set(property, *values); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:61
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:69
  def reload_user_class; end

  class << self
    # pkg:gem/sorcery#lib/sorcery/test_helpers/internal.rb:6
    def included(_base); end
  end
end

# pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:4
module Sorcery::TestHelpers::Internal::Rails
  ...
  # A dirty dirty hack.
  #
  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:53
  def clear_user_without_logout; end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:45
  def sorcery_controller_external_property_set(provider, property, value); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:41
  def sorcery_controller_property_set(property, value); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:13
  def sorcery_reload!(submodules = T.unsafe(nil), options = T.unsafe(nil)); end
end

# pkg:gem/sorcery#lib/sorcery/test_helpers/internal/rails.rb:7
Sorcery::TestHelpers::Internal::Rails::SUBMODULES_AUTO_ADDED_CONTROLLER_FILTERS = T.let(T.unsafe(nil), Array)

# pkg:gem/sorcery#lib/sorcery.rb:62
module Sorcery::TestHelpers::Rails; end

# pkg:gem/sorcery#lib/sorcery/test_helpers/rails/controller.rb:4
module Sorcery::TestHelpers::Rails::Controller
  # pkg:gem/sorcery#lib/sorcery/test_helpers/rails/controller.rb:15
  def logged_in?; end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/rails/controller.rb:5
  def login_user(user = T.unsafe(nil), _test_context = T.unsafe(nil)); end

  # pkg:gem/sorcery#lib/sorcery/test_helpers/rails/controller.rb:11
  def logout_user; end
end

# pkg:gem/sorcery#lib/sorcery/test_helpers/rails/integration.rb:4
module Sorcery::TestHelpers::Rails::Integration
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/test_helpers/rails/integration.rb:7
  ...
  #
  # pkg:gem/sorcery#lib/sorcery/test_helpers/rails/integration.rb:18
  def logout_user(route = T.unsafe(nil), http_method = T.unsafe(nil)); end
end

# pkg:gem/sorcery#lib/sorcery/test_helpers/rails/request.rb:4
