...
#
# pkg:gem/mysql2#lib/mysql2/version.rb:1
module Mysql2; end

# pkg:gem/mysql2#lib/mysql2.rb:36
class Mysql2::Client
  # pkg:gem/mysql2#lib/mysql2/client.rb:21
  ...
  # path is provide.
  #
  # pkg:gem/mysql2#lib/mysql2/client.rb:123
  def find_default_ca_path; end

  # pkg:gem/mysql2#lib/mysql2/client.rb:159
  def info; end
  ...
  #
  # pkg:gem/mysql2#lib/mysql2/client.rb:134
  def parse_connect_attrs(conn_attrs); end

  # pkg:gem/mysql2#lib/mysql2/client.rb:106
  def parse_flags_array(flags, initial = T.unsafe(nil)); end

  # pkg:gem/mysql2#lib/mysql2/client.rb:95
  def parse_ssl_mode(mode); end

  def ping; end
  def prepare(_arg0); end

  # pkg:gem/mysql2#lib/mysql2/client.rb:144
  def query(sql, options = T.unsafe(nil)); end

  # pkg:gem/mysql2#lib/mysql2/client.rb:150
  def query_info; end

  def query_info_string; end

  # pkg:gem/mysql2#lib/mysql2/client.rb:3
  ...
  # pkg:gem/mysql2#lib/mysql2/client.rb:165
  def check_and_clean_query_options; end
  ...
  def get_server_public_key=(_arg0); end
  ...
  class << self
    # pkg:gem/mysql2#lib/mysql2/client.rb:5
    ...
    # pkg:gem/mysql2#lib/mysql2/client.rb:181
...
# pkg:gem/mysql2#lib/mysql2/error.rb:2
class Mysql2::Error < ::StandardError
  # pkg:gem/mysql2#lib/mysql2/error.rb:53
  def initialize(msg, server_version = T.unsafe(nil), error_number = T.unsafe(nil), sql_state = T.unsafe(nil)); end

  # Mysql gem compatibility
  #
  # pkg:gem/mysql2#lib/mysql2/error.rb:50
  def errno; end

  # pkg:gem/mysql2#lib/mysql2/error.rb:51
  def error; end

  # pkg:gem/mysql2#lib/mysql2/error.rb:47
...
class Mysql2::Result
  ...
  # pkg:gem/mysql2#lib/mysql2/result.rb:3
...
class Mysql2::Statement
  ...
  # pkg:gem/mysql2#lib/mysql2/statement.rb:3
...
# pkg:gem/mysql2#lib/mysql2.rb:62
module Mysql2::Util
  class << self
    # Rekey a string-keyed hash with equivalent symbols.
    #
    # pkg:gem/mysql2#lib/mysql2.rb:66
    def key_hash_as_symbols(hash); end
  end
end

# pkg:gem/mysql2#lib/mysql2.rb:81
Mysql2::Util::TIMEOUT_ERROR_CLASS = Timeout::ExitException

# pkg:gem/mysql2#lib/mysql2.rb:86
Mysql2::Util::TIMEOUT_ERROR_NEVER = T.let(T.unsafe(nil), Hash)

# pkg:gem/mysql2#lib/mysql2/version.rb:2
