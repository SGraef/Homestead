...
class Location
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        records: T.any(::Location, Integer, String, T::Enumerable[T.any(::Location, Integer, String, T::Enumerable[::Location])])
      ).returns(Integer)
    end
    ...
    sig { params(args: T.untyped).returns(T::Array[::Location]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Location]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Location` class because it declared `has_many :storage_items`.
